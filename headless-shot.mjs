...
try {
  execFileSync('node', ['preview.mjs', idMatch[1], out, String(pw), String(ph)], { cwd: import.meta.dirname, timeout: 300_000, stdio: 'inherit', env: { ...process.env, REFR: process.env.REFR || '0' } })
