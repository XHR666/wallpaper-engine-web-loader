...
// ①(2026-09-16 目录整理修) **不要用 MPW_ROOT 覆盖 ROOT**：本仓库的 MPW_ROOT 是"工作区根"
//   （`$MPW_ROOT/allwallpaper`、`$MPW_ROOT/wallpaper_engine/...` 都从它解析），不是仓库根；
//   runner 导出它之后这里会指到工作区 ⇒ `ROOT/we-scene-bundle.js` ENOENT。仓库根只认脚本位置。
