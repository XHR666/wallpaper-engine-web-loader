...
```bash
npm i wallpaper-engine-web-loader@0.2.1     # 锁定已发布版本；或 npm i wallpaper-engine-web-loader 跟随 latest
```
...
```bash
npm pack wallpaper-engine-web-loader@0.2.1     # 得到 wallpaper-engine-web-loader-0.2.1.tgz
tar -xzf wallpaper-engine-web-loader-0.2.1.tgz   # 解开得到 package/（含 demo.html / elysia/ / samples/ 等）
```
