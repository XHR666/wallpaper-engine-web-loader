...
- 已发布 npm：[wallpaper-engine-web-loader@0.5.5](https://www.npmjs.com/package/wallpaper-engine-web-loader)
...
```bash
npm i wallpaper-engine-web-loader@0.5.5     # 锁定已发布版本；或 npm i wallpaper-engine-web-loader 跟随 latest
```
...
```bash
npm pack wallpaper-engine-web-loader@0.5.5     # 得到 wallpaper-engine-web-loader-0.5.5.tgz
tar -xzf wallpaper-engine-web-loader-0.5.5.tgz   # 解开得到 package/（含 demo.html / elysia/ / samples/ 等）
```
