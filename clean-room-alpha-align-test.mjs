...
const BUNDLE = path.join(import.meta.dirname, 'we-scene-bundle.js')
...
chk(fs.existsSync(path.join(import.meta.dirname, 'docs', 'IMAGE-ALPHA-ALIGN-SPEC.md')), '③ 行为规格 docs/IMAGE-ALPHA-ALIGN-SPEC.md 在位')
