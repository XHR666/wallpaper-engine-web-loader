...
- Published on npm: [wallpaper-engine-web-loader@0.5.7](https://www.npmjs.com/package/wallpaper-engine-web-loader)
...
```bash
npm i wallpaper-engine-web-loader@0.5.7     # pin the published version; or npm i wallpaper-engine-web-loader to follow latest
```
...
```bash
npm pack wallpaper-engine-web-loader@0.5.7     # produces wallpaper-engine-web-loader-0.5.7.tgz
tar -xzf wallpaper-engine-web-loader-0.5.7.tgz   # unpacks to package/ (containing demo.html / elysia/ / samples/ etc.)
```
