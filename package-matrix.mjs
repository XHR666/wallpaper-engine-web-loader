...
const OUT_JSON = path.join(import.meta.dirname, 'package-matrix.json')
const BASELINE = path.join(import.meta.dirname, 'package-baseline.json')
const KNOWN = path.join(import.meta.dirname, 'known.json')
